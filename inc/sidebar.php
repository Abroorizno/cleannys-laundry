<div class="app-brand demo">
    <a href="index.html" class="app-brand-link">
        ...
        <span class="app-brand-text fs-5 menu-text fw-bolder ms-2">Cleanny's Laundry</span>
    </a>
        ...
        <ul class="menu-sub">
            ...
            <li class="menu-item">
                <a href="forms-input-groups.html" class="menu-link">
                    <div data-i18n="Input groups">Reports</div>
                </a>
            </li>
        </ul>
    </li>
        ...
        <ul class="menu-sub">
            <li class="menu-item">
                <a href="?page=customer" class="menu-link">
                    <div data-i18n="Notifications">Customer Account</div>
                </a>
            </li>
            <li class="menu-item">
